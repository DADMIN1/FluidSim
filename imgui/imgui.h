...
namespace ImGui
{
    ...
    IMGUI_API void          ShowDemoWindow(bool* p_open = NULL, ImGuiWindowFlags p_flags = 0); // second parameter specifies default window-flags. (previously all flags were disabled always)
